...
INSERT INTO `matiere` (`id_mat`, `id_ue`, `id_mod`, `nom`, `label`, `couleur`, `themes`, `typeEns`) VALUES
(1, 1, 1, 'Programmation WEB côté Serveur (M3104)', 'PWEB MVC', '#1DE124', '{\n"web":"Client Serveur HTTP", \n"pattern":"MVC",\n"Langage":"PHP"\n}\n', '{\n"A":["promo", 1.5],\n\'M\':["bi",3]\n}'),
(2, 1, 1, 'Programmation WEB côté Serveur - JAVA (M3104-2)', 'PWEB JAVA', '#749C75', '{\n"Systeme WEB":"Client Serveur HTTP", \n"Langage":"JAVA"\n}\n', '{\n"A":["promo",1.5],\n"M":["bi",3]\n}'),
(9, 1, 1, 'Algorithmique avancée', 'AAV', '#98473E', '{"complexite": "tri"}', '{\n"A":["promo",1.5],\n"T":["bi",1.5],\n"M":["mono",1.5]\n}'),
(14, 2, 1, 'Anglais', 'ANG', '#BEB7DF', 'vocabulaire', '{"M":["mono",1.5]}'),
(15, 2, 1, 'Expression Communication', 'EC', '#D6C3C9', '{\n"expression":"écriture de rapport de stage",\n"communication":"soutenance orale"\n}', '{\n"T":["bi",1.5]\n}'),
(16, 1, 1, 'Modélisation Objet', 'MO', '#D4F2D2', '{"modele" : "UML"}', '{"A":["promo",1.5],\n\'M\':["bi",3]\n}'),
(17, 2, 1, 'PROBA STAT', 'PS', '#F6E27F', '{"proba": ["espace"], \n"stat": ["régression"]}', '{ "A":["promo",1.5], "M":["bi",3] }');

-- --------------------------------------------------------

--
-- Structure de la table `matperiod`
--

DROP TABLE IF EXISTS `matperiod`;
CREATE TABLE `matperiod` (
  `id_mat` int(4) NOT NULL,
  `id_period` int(11) NOT NULL,
  `nbH` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
--
-- Contenu de la table `matperiod`
--

INSERT INTO `matperiod` (`id_mat`, `id_period`, `nbH`) VALUES
(1, 1, 20),
(1, 2, 3),
(9, 1, 14),
(9, 2, 5);
